...
class KeyFrameDiskWriter(Writer):
    ...
    def write(self, filepath, data, frame_ids = []):
    ...
    def write_with_frame_id(self, filepath, data, frame_ids):
        """Write the data generated by Katna library for file @ filepath on to the disk.
        ...
        for img,id in zip(data, frame_ids):
            output_filename = self.generate_output_filename(filepath, keyframe_number=id)
            self.save_frame_data_to_disk(img, file_name=output_filename)
